      ...
      if (!form.checkValidity()) {
        if (nameInput) {
          var nameErrorMessage =
            nameInput.parentElement.querySelector(".invalid-feedback");
        ...
        if (passwordConfirmInput) {
          ...
          var passwordConfirmErrorMessage =
            passwordConfirmInput.parentElement.querySelector(
              ".invalid-feedback"
            );
          ...
          if (!passwordConfirmInput.checkValidity()) {
            if (passwordConfirmInputValue.length == 0) {
              ...
              var minlengthPass = parseInt(
                passwordConfirmInput.getAttribute("minlength")
              );
